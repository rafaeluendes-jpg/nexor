...
function fecharCaixa(id){
  ...
  modal('Fechamento de caixa',h,'Confirmar fechamento',async function(){
   /* ==========================================================
      O CLIQUE NUNCA PODE MORRER CALADO

      29/08/2026: a loja clicava em Confirmar e nada acontecia. Cada
      saida deste caminho que devolvia `false` sem dizer nada — a trava
      de duplo toque, a autorizacao, um erro no meio — deixava a pessoa
      olhando para a tela sem entender. Do lado de fora nao havia como
      distinguir "o sistema recusou" de "o botao nao funciona".

      Agora TODA saida fala, e qualquer erro no meio aparece na tela em
      portugues e fica gravado no Diagnostico com o motivo tecnico.
      ========================================================== */
   try{
    ...
    return true;
     ...
     try{registrarFalha('caixa','fecharCaixa',(e&&e.message)||String(e),
       {situacao:'o fechamento não foi concluído'})}catch(e2){}
     toast('Não consegui concluir o fechamento: '+((e&&e.message)||'erro inesperado')+
       '. Nada foi perdido — o caixa continua aberto. O motivo ficou no Diagnóstico.');
     return false;
   }
  },'lg');
