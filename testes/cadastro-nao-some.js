...
grupo('E a restauração da sessão não estoura');

const restaura = (function () {
  const i = fonte.indexOf('/* se ja tinha entrado antes, volta direto para o sistema */');
  return i > 0 ? fonte.slice(i, i + 900) : '';
})();
t('o "manter conectado" existe', /nexor_sessao/.test(restaura));
