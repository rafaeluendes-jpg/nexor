...
const MENU: { grupo: string; links: Link[] }[] = [
  ...
  },
  {
    ...
    links: [
      ...
      { href: '/pracas', label: 'Praças', permissao: 'crm.leads.view' },
    ],
  },
  {
    grupo: 'Análise',
    links: [
      { href: '/relatorios', label: 'Relatórios', permissao: 'crm.reports.view' },
      { href: '/origem', label: 'Origem dos leads', permissao: 'crm.reports.view' },
      { href: '/exportacoes', label: 'Exportações', permissao: 'crm.reports.export' },
    ],
  },
  {
    grupo: 'Administração',
    links: [
      { href: '/usuarios', label: 'Usuários e acessos', permissao: 'crm.users.view' },
      ...
      { href: '/integracao', label: 'Integração WhatsApp', permissao: 'crm.integrations.view' },
      { href: '/configuracoes', label: 'Configurações', permissao: 'crm.settings.view' },
